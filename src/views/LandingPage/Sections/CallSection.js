    ...
    <div className={classes.section}>
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={8}>
          ...
          <Paper className={classes.paper} elevation={3} children={(<span><strong>Applications</strong> of self-supervised models to downstream tasks, such as automatic speech recognition, speech enhancement, speech augmentation, and spoken language understanding</span>)} />
          ...
          <h5 className={classes.description}>
          The submissions should be in <strong>NeurIPS</strong> style between <strong>4 to 8 pages, excluding the references</strong>. Authors can add supplementary material in addition to the eight pages, but reviewers are not required to review the extra material. Original works are preferred. Submissions that are under review by other venues or published on <strong>arXiv</strong> or similar repositories are acceptable. Submissions will be reviewed by at least three reviewers. Authors and reviewers are asked to disclose any possible conflict of interest, and the organizers will manage the conflict of interest when assigning submissions for reviews. Note that our workshop is not archival, but the accepted papers will be hosted on the workshop website. For reproducibility, we also encourage the authors to release the code of their experiments publicly.
          </h5>
        </GridItem>
      </GridContainer>
    </div>
